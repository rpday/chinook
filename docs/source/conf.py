...
latex_documents = [
    (master_doc, 'chinook.tex', 'chinook Documentation',
     'Ryan P. Day', 'manual'),
]
...
man_pages = [
    (master_doc, 'chinook', 'chinook Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'chinook', 'chinook Documentation',
     author, 'chinook', 'One line description of project.',
     'Miscellaneous'),
]
