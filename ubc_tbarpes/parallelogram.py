...
def what_side(point,edge):
    '''
    The 'side' of a line edge point sits on, defined by the sign of the sgn function for the angle between the two, assuming a common origin.
    args:
...
def in_pgram(p2D,e2D,ezero,maxlen):
    '''
...
#    
#    inside_pt,outside_pt = check_in(pts2,edges)
#    
#    plot(pts,inside_pt,outside_pt,edges)